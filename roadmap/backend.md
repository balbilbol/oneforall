...
17. PHP For Beginners - Complete Laracasts Course = https://www.youtube.com/watch?v=fw5ObX8P6as
...
2. Frontend Basics = https://www.youtube.com/watch?v=xiWUL3M9D8c
   - HTML
   - CSS
   - JavaScript
3. Pick Backend Languange
   ...
   - C#
   - Ruby
   - PHP = https://www.youtube.com/watch?v=fw5ObX8P6as
   - Rust
...
5. Repo Hosting Services
   - Github
   - Gitlab
6. Relational Database = https://www.youtube.com/watch?v=WXk7yDqsKxs, https://www.youtube.com/watch?v=ZA25WHO62ZA
   - MySQL
   - PostgreSQL
   - SQLite
   - MariaDB
   ...
   1. Migrations
   2. N+1 Problem
7. Learn about API = https://www.youtube.com/watch?v=WXsD0ZgxjRw, https://restfulapi.net/
   1. API Styles
      - REST = https://www.youtube.com/watch?v=2JYT5f2isg4
      - JSON APIs
      - SOAP
      - gRPC
      - GraphQL
